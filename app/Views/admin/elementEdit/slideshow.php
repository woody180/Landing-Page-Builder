<div class="uk-flex uk-flex-between uk-flex-middle uk-margin-bottom">
    <div><h2 class="uk-modal-title uk-margin-remove">Slideshow management</h2></div>
    
    <div>
        <button class="uk-button uk-button-primary ld-add-new-slideshow-item">Add new item</button>
    </div>
</div>


<form>
    <ul class="uk-list uk-list-divider" id="ld-slideshow-management" uk-sortable="handle: .ld-sort-slideshow-item" data-id="<?= $id ?>">
            ...
            <div>
                ...
                <div class="uk-flex uk-flex-bottom uk-flex-between">
                    <a href="#" class="object-cover uk-display-block" style="height: 50px;">
                        ...
                        <img class="preview-image" style="height: 100%;" class="uk-display-block " src="<?= assetsUrl("tinyeditor/filemanager/files/{$item->image}") ?>" />
                    </a>
    ...
    <div class="uk-modal-footer uk-text-right">
        <button class="uk-button uk-button-primary ld-save-slideshow" type="submit">Save</button>
    </div>
</form>